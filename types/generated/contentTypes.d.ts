...
export interface ApiActionAction extends Struct.SingleTypeSchema {
...
export interface ApiBillingAddressBillingAddress
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    billing_instructions: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    users: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    ward_number: Schema.Attribute.Integer;
...
export interface ApiCartCart extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cart_status: Schema.Attribute.Enumeration<
    ...
    item_in_carts: Schema.Attribute.Relation<
      'oneToMany',
      'api::item-in-cart.item-in-cart'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiCollectionSectionCollectionSection
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::collection-section.collection-section'
    > &
      Schema.Attribute.Private;
    products: Schema.Attribute.Relation<'manyToMany', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    seo_meta: Schema.Attribute.Component<'seo-meta.seo-meta', true>;
...
export interface ApiCouponCoupon extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    applies_to: Schema.Attribute.Enumeration<['all', 'category', 'product']>;
    code: Schema.Attribute.UID;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    expires_at: Schema.Attribute.DateTime;
    internal_note: Schema.Attribute.Text & Schema.Attribute.Required;
    ...
    min_order: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
    type: Schema.Attribute.Enumeration<
      ['percent', 'fixed', 'free_shipping', 'overall_discount']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    usage_limit: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
...
export interface ApiInventoryInventory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    is_low_stock: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    low_stock_alert: Schema.Attribute.Integer;
    product: Schema.Attribute.Relation<'manyToOne', 'api::product.product'>;
...
export interface ApiItemInCartItemInCart extends Struct.CollectionTypeSchema {
...
export interface ApiNotificationNotification
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
    type: Schema.Attribute.Enumeration<['Info', 'Order', 'Alert', 'Emergency']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOrderCollectionOrderCollection
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currency: Schema.Attribute.String;
    customer_message: Schema.Attribute.Text;
    final_total: Schema.Attribute.Decimal;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::order-collection.order-collection'
    > &
      Schema.Attribute.Private;
    order_items_collections: Schema.Attribute.Relation<
      'oneToMany',
      'api::order-items-collection.order-items-collection'
    >;
    ...
    payment_user: Schema.Attribute.Relation<
      'oneToOne',
    ...
    total_discount: Schema.Attribute.Decimal;
    total_price: Schema.Attribute.Decimal;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOrderItemsCollectionOrderItemsCollection
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    order_collection: Schema.Attribute.Relation<
      'manyToOne',
      'api::order-collection.order-collection'
    >;
    product: Schema.Attribute.Relation<'manyToOne', 'api::product.product'>;
...
export interface ApiPaymentUserPaymentUser extends Struct.CollectionTypeSchema {
...
export interface ApiProductOptionProductOption
  ...
  attributes: {
    ...
    inventories: Schema.Attribute.Relation<
      ...
      'api::inventory.inventory'
    >;
    item_in_cart: Schema.Attribute.Relation<
      'oneToOne',
      'api::item-in-cart.item-in-cart'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    product: Schema.Attribute.Relation<'manyToOne', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    Size_And_Color: Schema.Attribute.Component<
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    collection_sections: Schema.Attribute.Relation<
      'manyToMany',
      'api::collection-section.collection-section'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    productOptions: Schema.Attribute.Relation<
      'oneToMany',
      'api::product-option.product-option'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiTransactionTransaction extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    type: Schema.Attribute.Enumeration<
      ['payment_in', 'refund', 'payout', 'fee', 'adjustment', 'other']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    notifications: Schema.Attribute.Relation<
      ...
      'api::notification.notification'
    >;
    order_collections: Schema.Attribute.Relation<
      'oneToMany',
      'api::order-collection.order-collection'
    >;
    password: Schema.Attribute.Password &
    ...
    payment_users: Schema.Attribute.Relation<
      'oneToMany',
      'api::payment-user.payment-user'
    >;
    provider: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::order-collection.order-collection': ApiOrderCollectionOrderCollection;
      'api::order-items-collection.order-items-collection': ApiOrderItemsCollectionOrderItemsCollection;
      'api::payment-method.payment-method': ApiPaymentMethodPaymentMethod;
      'api::payment-user.payment-user': ApiPaymentUserPaymentUser;
